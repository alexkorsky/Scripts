...
features_list1 = ["bonus", "salary"]
features_list2 = ["bonus", "long_term_incentive"]
data = featureFormat( dictionary, features_list1, remove_any_zeroes=True, sort_keys = '../tools/python2_lesson06_keys.pkl')
...
stupid_tes_score = reg.score(feature_train, target_train)
